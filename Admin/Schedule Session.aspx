<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Schedule Session.aspx.vb" Inherits="Hospital_Appointment_System.Schedule_Session" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Schedule a Session - Dashboard</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="main-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <!-- Search Box with Button -->
                <div style="max-width: 350px; width: 100%;">
                    <h4 style="font-weight: bold;">Schedule A Session</h4>
                    <p>All Sessions <span id="totalSessions">(0)</span></p>
                </div>
